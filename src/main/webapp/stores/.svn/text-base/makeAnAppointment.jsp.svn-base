		...
		<script type="text/javascript">
			layui.use(['element', 'table', 'layer', 'laydate','form'], function() {
				...
				table.on('tool(test)', function(obj) {
					...
					if(obj.event === 'del') {
						...
						layer.open({
							  ...
							  success:function(){
								$("#infosId").text(data.mid);
								$("#infoName").text(data.name);
								$("#infoPhone").text(data.phone);
								$("#infoAddress").text(data.time);
				...
				form.on('submit(add)',function(){
					...
					$.post("../mak/add.do",formData,function(res){
						if(res=="true"){
				...
				form.on('submit(upd)',function(){
					...
					$.post("../mak/upodate.do",formData,function(res){
							if(res){
