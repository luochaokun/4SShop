                                    ...
                                    <ul>
                                        ...
                                        <li class="dropdown"><a href="javascript:;"  class="active">最新活动</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="${pageContext.request.contextPath}/Thefrontdeskblog_right_sidebar.jsp">活动</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <h1>维修门店</h1>
                    <ol class="breadcrumb">
                          <li class="dropdown"><a href="../Frontdesk/Frontdesk.do">首页</a>
                        <li class="breadcrumb-item active">维修门店</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-md-9 impl_blog_section impl_right_blog">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <!--blog1-->
                                        <c:forEach items="${store}" var="sto">
                                        <div class="impl_blog_box">
                                            <div class="">
                                                <img src="${pageContext.request.contextPath}/Thefrontdesk/images/blog/blog1.jpg" alt=""  />
                                             
                                            </div>
                                            <div class="impl_post_data">
                                                <h2><a href="blog_single.jsp">门店名称：${sto.name} </a></h2>
                                                
                                                
                                                <div class="impl_pst_info">
                                                    <div class="impl_pst_admin">
                                                        <span><a href="#">联系电话：${sto.phone}</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                         
                                                    </div>
                                                    <div>
                                                    	<span>门店地址：${sto.address}</span>
                                                     </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3">
                                <div class="impl_sidebar">
                                    ...
                                    <div class="widget widget_recent_entries">
                                        <h2 class="widget-title">服务人员</h2>
                                        <ul>
                                            <li>
                                                <div class="recent_cmnt_img">
                                                    <img src="${pageContext.request.contextPath}/Thefrontdesk/images/blog/author1.jpg" alt="">
                                                </div>
                                                <div class="recent_cmnt_data">
                                                    <h4><a href="#">李四</a></h4>
                                                  	<samp>电话：18008593641</samp>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="recent_cmnt_img">
                                                    <img src="${pageContext.request.contextPath}/Thefrontdesk/images/blog/author2.jpg" alt="">
                                                </div>
                                                <div class="recent_cmnt_data">
                                                    <h4><a href="#">小花</a></h4>
                                                    <span>电话：18008593641</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="recent_cmnt_img">
                                    ...
                                    <div class="widget widget_instagram_feed">
                                        <h2 class="widget-title">服务类型</h2>
                                        <ul>
                                            <li><a href="#"><img src="${pageContext.request.contextPath}/Thefrontdesk/images/blog/r_post1.jpg" alt=""></a></li>
