		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				...
				<ol class="breadcrumb">
				  ...
				  <li class="breadcrumb-item active">404 页面</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="error_text">
					...
					<h1>ooopps....</h1>
					<p>你要找的那一页找不到。 </p>
					<a href="index.jsp" class="impl_btn">主页</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="impl_foo_box">
						...
						<ul>
							<li><div class="impl_foo_icon"><i class="fa fa-phone" aria-hidden="true"></i></div><div class="impl_foo_text"><p>+1-202-555-0137</p><p>+1-202-555-0137</p></div></li>
							<li><div class="impl_foo_icon"><i class="fa fa-map-marker" aria-hidden="true"></i></div><div class="impl_foo_text"><p>514 S. Magnolia St. <br> Orlando , US</p></div></li>
							<li>
